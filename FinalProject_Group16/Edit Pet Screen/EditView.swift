...
class EditView: UIView {
    ...
    func setupTitleLabel() {
        titleLabel = UILabel()
        titleLabel.text = "Edit Pet Profile"
    ...
    func setupEditPhotoButton() {
        editPhotoButton = UIButton(type: .system)
        editPhotoButton.setTitle("Edit Pet Photo", for: .normal)
        editPhotoButton.setTitleColor(.systemBlue, for: .normal)
        editPhotoButton.titleLabel?.font = UIFont.systemFont(ofSize: 16)
        editPhotoButton.layer.cornerRadius = 16
    ...
    func initConstraints() {
        NSLayoutConstraint.activate([
            ...
            petImageView.widthAnchor.constraint(equalTo: contentWrapper.widthAnchor, multiplier: 0.4),
            petImageView.heightAnchor.constraint(equalTo: petImageView.widthAnchor),
            
            editPhotoButton.centerXAnchor.constraint(equalTo: petImageView.centerXAnchor),
            editPhotoButton.centerYAnchor.constraint(equalTo: petImageView.centerYAnchor),

            // Pet Type Buttons
            dogButton.topAnchor.constraint(equalTo: petImageView.bottomAnchor, constant: 24),
